...
// ======================================   MENU CLICK ============================================================
var ListLinkItemMenu = document.querySelectorAll('#news-management .menu-management  .menu-management-item  .link');

var ListItemContent = document.querySelectorAll('#news-management .content-menu-item');

Array.from(ListLinkItemMenu).forEach((el, idx) => {
    el.addEventListener('click' , function(event){
        event.preventDefault();
        Array.from(ListLinkItemMenu).forEach((element, index) => {
        ...
        Array.from(ListItemContent).forEach((element, index) => {
